...
hint: "[--no-prd] [--no-deslop] <task description>"
allowed-tools: [readFile, editFiles, search, codebase, problems, runInTerminal, findTestFiles, testFailures, usages]
---
...
## When NOT to Use
- Full autonomous pipeline → use `/autopilot`
