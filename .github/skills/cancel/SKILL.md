...
hint: "[--force|--all]"
allowed-tools: [readFile, editFiles, runInTerminal]
---
...
3. Mark autopilot inactive (preserve state for resume)

#### If Ralph Active (not Autopilot)
...
|------|-----------------|----------------|
| Autopilot | Yes (phase, files, spec) | `/autopilot` |
...
|------|-----------------|
| Autopilot | "Autopilot cancelled at phase: {phase}. Progress preserved." |
