...
hint: "[N:agent-type] [ralph] <task description>"
allowed-tools: [readFile, editFiles, search, codebase, problems, runInTerminal, findTestFiles, testFailures]
---
...
## When NOT to Use
- Single-file changes → use `/autopilot` or direct editing
- Sequential pipeline → use `/autopilot`
