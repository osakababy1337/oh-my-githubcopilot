...
description: >
  ...
  autopilot execution, ralph loops, team coordination, workflow orchestration.
...
1. **Expansion** (Phase 0): Analyze requirements -> `.omc/autopilot/spec.md`
2. **Planning** (Phase 1): Create implementation plan -> `.omc/plans/autopilot-impl.md`
...
**Pipeline**: [autopilot/ralph/review/plan/team]
**Phase**: [current phase]
